...
const MovementPopup: React.VFC<AddMovementProps> = ({
    ...
    const [movementData, setMovementData] = useState<Partial<IMovement>>(movement ? movement : {
            ...
            <Transition.Root show={showPopup} as={Fragment}>
                <Dialog as="div" className="relative z-10" onClose={() => hidePopup()}>
                    ...
                    <div className="fixed inset-0 z-10 overflow-y-auto">
                        <div
                            className="flex h-full m-auto justify-center p-4 text-center sm:items-center sm:p-0">
                            <Transition.Child
                                as={Fragment}
                                enter="ease-out duration-300"
                                        ...
                                        <div className="mx-auto w-full max-w-sm lg:w-96">
                                            ...
                                            <div>
                                                <h2 className="mt-3 text-2xl font-medium text-gray-900 text-center">
                                                    {movement ? `Edit movement` : `New Movement`}</h2>
                                            </div>
                                                        ...
                                                        <div className="space-y-1">
                                                            ...
                                                            <div className="mt-1">
                                                                <input
                                                                    ...
                                                                    onChange={(e) => updateDetails(`amount`, e.target.valueAsNumber)}
                                                                    required
