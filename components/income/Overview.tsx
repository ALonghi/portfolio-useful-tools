...
const Overview: React.FC<OverviewProps> = (props) => {
    const totalIncome: number =
        props.movements
            ...
            ?.map((m) => (m.frequency === "yearly" ? m.amount / 12 : m.amount))
    ...
    const totalInvestments: number =
        props.movements
            ...
            ?.map((m) => (m.frequency === "yearly" ? m.amount / 12 : m.amount))
            ?.reduce((p: number, c: number) => p + c, 0) || 0;
    const totalRequiredExpenses: number =
        props.movements
    ...
    const totalAdditionalExpenses: number =
        props.movements
            ?.filter((m) => m.movementType === "expense" && m.reason !== "necessary")
            ?.filter((m) => !m.isInactive)
            ?.map((m) => (m.frequency === "yearly" ? m.amount / 12 : m.amount))
    ...
    return (
        <div className={props.classes ? props.classes : ``}>
            <div className={`mt-12 flex items-center `}>
                ...
                <p
                    className={`ml-4 mt-auto text-base font-normal 
                ${totalIncome > 0 ? `text-emerald-500` : `text-red-500`}`}
                >
                    {totalIncome > 0 ? `+` : ``} {Utils.formatAmount(monthlyGain)} CHF
                </p>
                <p
                    className={`ml-2 mt-auto text-base font-light 
                ${
                        totalIncome + initialCapital > 0
                            ? `text-emerald-600`
                            : `text-red-500`
                    }`}
                >
                    (
                    {Utils.formatAmount(
                        initialCapital + parseInt(monthlyGain.toFixed(0))
                    )}
                    )
                </p>
            </div>
            <div className={`mt-2 flex items-center `}>
                ...
                >
                    {totalIncome > 0 ? `+` : ``}{" "}
                    {Utils.formatAmount(parseInt((monthlyGain * 3).toFixed(0)))} CHF
                </p>
                <p
                    className={`ml-2 mt-auto text-base font-light 
                ${
                ...
                >
                    (
                    {Utils.formatAmount(
                        initialCapital + parseInt((monthlyGain * 3).toFixed(0))
                    )}
                    )
                </p>
            </div>
            <div className={`mt-2 flex items-center `}>
                ...
                >
                    {totalIncome > 0 ? `+` : ``}{" "}
                    {Utils.formatAmount(parseInt((monthlyGain * 6).toFixed(0)))} CHF
                </p>
                <p
                    className={`ml-2 mt-auto text-base font-light 
                ${
                ...
                >
                    (
                    {Utils.formatAmount(
                        initialCapital + parseInt((monthlyGain * 6).toFixed(0))
                    )}
                    )
                </p>
            </div>
            <div className={`mt-2 flex items-center `}>
                ...
                >
                    {totalIncome > 0 ? `+` : ``}{" "}
                    {Utils.formatAmount(parseInt((monthlyGain * 12).toFixed(0)))} CHF
                </p>
                <p
                    className={`ml-2 mt-auto text-base font-light 
                ${
                ...
                >
                    (
                    {Utils.formatAmount(
                        initialCapital + parseInt((monthlyGain * 12).toFixed(0))
                    )}
                    )
                </p>
            </div>
            {yearsToShow.map((years, i) => (
                ...
                ${totalIncome > 0 ? `text-emerald-500` : `text-red-500`}`}
                    >
                        {totalIncome > 0 ? `+` : ``}{" "}
                        {Utils.formatAmount(
                            parseInt((monthlyGain * 12 * years).toFixed(0))
                        )}{" "}
                        CHF
                    </p>
                    <p
                ...
                ${
                    ...
                    >
                        (
                        {Utils.formatAmount(
                            initialCapital + parseInt((monthlyGain * 12 * years).toFixed(0))
                        )}
                        )
                    </p>
                </div>
            ...
            <div className={`mt-12 mb-4 `}>
                ...
                <div className={`flex`}>
                    ...
                    <p className={`ml-4 mt-auto text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalIncome)} CHF
                    </p>
                </div>
                <div className={`flex`}>
                    <h2 className={`font-light text-xl my-auto`}>Yearly</h2>
                    <p className={`ml-4 mt-auto text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalIncome * 12)} CHF
                    </p>
                </div>
            </div>
            ...
            <div className={`my-4 `}>
                <div className={`flex items-center mb-2`}>
                    ...
                    <p className={`font-light text-xl ml-4 `}>
                        {Utils.formatAmount(
                            parseInt(((totalInvestments * 100) / totalIncome).toFixed(0))
                        )}{" "}
                        %
                    </p>
                </div>
                <div className={`flex`}>
                    <h2 className={`font-light text-xl my-auto`}>Monthly</h2>
                    <p className={`ml-4 mt-auto text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalInvestments)} CHF
                    </p>
                </div>
                <div className={`flex`}>
                    <h2 className={`font-light text-xl my-auto`}>Yearly</h2>
                    <p className={`ml-4 mt-auto text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalInvestments * 12)} CHF
                    </p>
                </div>
            </div>
            ...
            <div className={`my-4 `}>
                <div className={`flex items-center mb-2`}>
                    ...
                    <p className={`my-auto font-light text-xl ml-3 `}>
                        {Utils.formatAmount(
                            parseInt(
                                (
                                    ((totalRequiredExpenses + totalAdditionalExpenses) * 100) /
                                    totalIncome
                                ).toFixed(0)
                            )
                        )}
                ...
                <div className={`flex items-center mb-2`}>
                    ...
                    <p className={`ml-3 my-auto text-sm font-light text-gray-600`}>
                        {Utils.formatAmount(
                            parseInt(((totalRequiredExpenses * 100) / totalIncome).toFixed(0))
                        )}{" "}
                        %
                    </p>
                </div>
                <div className={`flex items-center mb-2`}>
                    ...
                    <p className={`ml-4 text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalRequiredExpenses)} CHF
                    </p>
                </div>
                <div className={`flex`}>
                    <h2 className={`font-light text-xl my-auto`}>Yearly</h2>
                    <p className={`ml-4 mt-auto text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalRequiredExpenses * 12)} CHF
                    </p>
                </div>
                <div className={`flex items-center my-2`}>
                    ...
                    <p className={`ml-3 my-auto text-sm font-light text-gray-600`}>
                        {Utils.formatAmount(
                            parseInt(
                                ((totalAdditionalExpenses * 100) / totalIncome).toFixed(0)
                            )
                        )}{" "}
                        %
                    </p>
                ...
                <div className={`flex`}>
                    <h2 className={`font-light text-xl my-auto`}>Monthly</h2>
                    <p className={`ml-4 mt-auto text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalAdditionalExpenses)} CHF
                    </p>
                    <p className={`ml-3 mt-auto text-sm font-light text-gray-600`}>
                        ({Utils.formatAmount(totalAdditionalExpenses / 4)} weekly)
                    </p>
                </div>
                <div className={`flex mb-2`}>
                    <h2 className={`font-light text-xl my-auto`}>Yearly</h2>
                    <p className={`ml-4 mt-auto text-base font-bold text-indigo-600`}>
                        {Utils.formatAmount(totalAdditionalExpenses * 12)} CHF
                    </p>
                </div>
            </div>
        </div>
