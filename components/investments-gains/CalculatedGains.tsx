    ...
    return (
        <div className="mt-10 bg-white overflow-hidden shadow rounded-lg">
            <div className="px-6 py-8 sm:p-6">
                <h3
                    className={`my-4 text-xl font-bold text-gray-900 tracking-tight sm:text-2xl`}
                >
                    After {calculated.years} Years
                </h3>
                <ul>
                    <li>
                    ...
                    <li>
                        <div className={infoDivClasses}>
                            ...
                            <p className={`font-medium text-green-500`}>
                                +{" "}
                                {(
                                    (calculated.totalValue * 100) /
                                    calculated.totalInvested
                                ).toFixed()}{" "}
                                %
                            </p>
                        </div>
                ...
                <div>
                    ...
                    <ul>
                            ...
                            <li key={index}>
                                <div className={infoDivClasses}>
                                    ...
                                    <p>
                                        €{" "}
                                        {calculated.history
                                            .find((year) => year.year === index + 1)
                                            .yearGain.toLocaleString(`it-IT`)}
                                    </p>
                                </div>
                            </li>
                        ))}
                        <li>
                            <div className={infoDivClasses}>
                                <p className={`w-8/12`}>
                                    Additional year on plan ({calculated.years + 1}th){" "}
                                </p>
                                <p>
                                    €{" "}
                                    {CalculationFacility.calculate(
                                        0,
