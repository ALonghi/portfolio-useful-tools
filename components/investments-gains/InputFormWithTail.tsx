        ...
        <div className={`mx-2 `}>
            ...
            <div className="w-2/5 mt-1 relative rounded-md shadow-sm w-max flex flex-row justify-items-start items-center">
                <input
                    ...
                    sm:text-sm border-gray-300 rounded-md max-w-[6rem]"
                    placeholder={props.placeholder}
                    aria-describedby="price-currency"
                    onChange={(e) => props.updateValue(e.target.valueAsNumber)}
                />
                <div
                    className="absolute inset-y-0 right-5 pr-3 flex items-center pointer-events-none w-max overflow-visible">
