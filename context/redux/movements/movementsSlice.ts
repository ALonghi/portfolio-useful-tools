...
export const movementsSlice = createSlice({
    ...
    reducers: {
        ...
        updateMovements: (state, {payload: movements}: PayloadAction<IMovement[]>) => {
...
export const movementStateSelector = (state: RootState) => state.movementReducer
export const movementsSelector = (state: RootState) => state.movementReducer?.movements
...
export const movementsIsAsyncSelector = (state: RootState) => state.movementReducer?.isAsync
export const productsLastVisibleSelector = (state: RootState) => state.movementReducer?.lastVisible
