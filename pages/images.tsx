...
const ImagesToolPage = () => {
    ...
    return (<>
            ...
            <div className={`flex flex-col max-w-full`}>
                ...
                <div className={`mt-2 mb-12 font-light text-sm text-center w-10/12 mx-auto`}>
                    <p className={`italic`}>(Image sizes will be resized to 1000x1000 px) </p>
                </div>
                ...
                flex-wrap gap-x-4 md:gap-x-6 gap-y-4`}>
                        ...
                        {/*    </div>*/}
                        {/*</div>*/}
                        <SwitchWithLabel label={"Convert to WebP"} updateSelection={(v) => setWithConvertToWebp(v)}
